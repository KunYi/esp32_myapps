                              ...
                              int32_t event_id, void *event_data)
{
    ...
    case ETHERNET_EVENT_CONNECTED:
        ...
        ESP_LOGI(TAG, "Speed: %s, Duplex: %s",
                (speed == ETH_SPEED_10M) ? "10M" : "100M",
...
#define ETH_EN_CLOCK 16

static void wt32_eth01_end_eth_clock(void)
{
    gpio_reset_pin(ETH_EN_CLOCK);
    gpio_set_direction(ETH_EN_CLOCK, GPIO_MODE_OUTPUT);
    gpio_set_level(ETH_EN_CLOCK, 1);
}
